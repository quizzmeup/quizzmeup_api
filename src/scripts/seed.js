...
(async () => {
  try {
    //mongodb+srv://techsightreacteur:aGULiGO0PRggFxXa@techsight.thf9xhv.mongodb.net/TechSight

    await mongoose.connect(
      "mongodb+srv://techsightreacteur:aGULiGO0PRggFxXa@techsight.thf9xhv.mongodb.net/BDD"
    );
